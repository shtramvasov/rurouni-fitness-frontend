        ...
        <Grid2 container sx={{ flexDirection: 'column' }} spacing={3}>
          ...
          <Grid2 container sx={{ justifyContent: 'space-between', flexDirection: 'row', gap: 3 }} size={12}>
            <Grid2 sx={{ display: 'flex', flexDirection: 'column', gap: 0.5 }} >
             ...
             <Switch checked={emailSettings.news_updates} onChange={(e) => setEmailSettings(prev => ({ ...prev, news_updates: e.target.checked }))} />
          </Grid2>
          <Divider />
        ...
        <Grid2 container sx={{ flexDirection: 'column' }} spacing={3}>
          ...
          <Grid2 container sx={{ justifyContent: 'space-between', flexDirection: 'row', gap: 3 }} size={12}>
            <Grid2 sx={{ display: 'flex', flexDirection: 'column', gap: 0.5 }} >
             ...
             <Switch checked={telegramSettings.workout_reminders} onChange={(e) => setTelegramSettings(prev => ({ ...prev, workout_reminders: e.target.checked }))} />
          </Grid2>
          <Divider />
          ...
          <Grid2 container sx={{ justifyContent: 'space-between', flexDirection: 'row', gap: 3 }} size={12}>
            <Grid2 sx={{ display: 'flex', flexDirection: 'column', gap: 0.5 }} >
             ...
             <Switch checked={telegramSettings.security_alerts} onChange={(e) => setTelegramSettings(prev => ({ ...prev, security_alerts: e.target.checked }))} />
          </Grid2>
